...
if(electric<=50){
  ...
  price += 50 *price1 + 50 *price2 + 100 *price3 +((electric-200))*price4
}else{
  price += 50 *price1 + 50 *price2 + 100 *price3 + 150*price4 + ((electric-350))*price5
...
function tax(firsttax ,per1 ,per2 ,per3 ,per4 ,per5 ,per6 ,per7 ){
  ...
  if(firsttax <= 60e6){
    ...
    taxPay += 60e6 *per1 + 60e6 *per2 + 90e6 *per3 + (firsttax - 210e6)*per4
  
  }else if (firsttax <= 624e6){
    taxPay += 60e6 *per1 + 60e6 *per2 + 90e6 *per3 + 174e6 *per4 + (firsttax - 384e6)*per5
  
  }else if (firsttax <=960e6){
    taxPay += 60e6 *per1 + 60e6 *per2 + 90e6 *per3 + 174e6 *per4 + 240e6 *per5 + (firsttax - 624e6)*per6

  }else{
   taxPay += 60e6 *per1 + 60e6 *per2 + 90e6 *per3 + 174e6 *per4 + 240e6 *per5 + 336e6 *per6 (firsttax - 624e6)*per7
